...
function keller_banner(){
  echo "\e[37m
           SS Vortex Android\e[35m Fudendo Cheaters\e[91m
...
function detectarBypassShell() {
    ...
    foreach ($arquivosConfig as $arquivo) {
     ...
     if (empty($resultadoGitHelp) || strpos($resultadoGitHelp, 'usage: git') === false) {
         $comandoTestClone = 'adb shell "cd /tmp 2>/dev/null || cd /data/local/tmp; timeout 5 git clone https://github.com/bringRhbb/VortexSS test-repo 2>&1 | head -3"';
    ...
    else
    {
        if ($opcaoscanner == "0") {
            ...
            echo $bold . $azul . "[+] Checando se o replay foi passado...\n";
                ...
                echo $bold . $branco . "\n\n\t Fim da detecção no Termux.\n";
                echo $bold . $branco . "\t                 Com carinho, Vortex.\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n";
            ...
            echo $bold . $azul . "[+] Checando se o replay foi passado...\n";
                ...
                echo $bold . $branco . "\n\n\t Fim da detecção no Termux, obrigado por compactuar por um cenário limpo de cheats.\n";
                echo $bold . $branco . "\t                 Com carinho, Vortex.\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n";
        } elseif ($opcaoscanner == 's' || $opcaoscanner == 'S') {
            echo "\n\n\t  Fim da deteccão no Termux, obrigado por compactuar por um cenário limpo de cheats.\n\n";
            die();
        }
      }
?> 